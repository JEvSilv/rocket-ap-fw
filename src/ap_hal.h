...
//Mode configuration	0x80004300	0	sel_internal_col	sel_col	op_direction	cmd
//Control settings	0x80004304	1	reserved	ap_if_state	ap_trigger_ap	ap_rst
//AP irq	0x80004308	2	reserved	reserved	reserved	state_irq*
